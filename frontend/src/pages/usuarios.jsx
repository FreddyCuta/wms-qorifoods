      ...
      <div className="mx-auto max-w-4xl space-y-8">
        <div>
          <div className="mb-4 flex items-center justify-between">
            ...
            <ActionButton onClick={() => setModal({ kind: "create" })}>
              Nuevo Usuario
            </ActionButton>
          </div>
  ...
  return (
    <Modal open onClose={onClose} title="Desactivar usuario">
      <p className="text-sm text-muted-foreground">
        ...
        <span className="font-medium text-foreground">{user.nombre}</span>? El
      ...
      {hasPending && (
        <div className="mt-4 flex items-start gap-2 rounded-md border border-warning/30 bg-warning/10 px-3 py-2.5 text-sm text-warning">
          ...
          <p>
            ...
            desactiva, dichas tareas quedarán sin responsable asignado. ¿Desea
            continuar?
          </p>
        </div>
      )}
